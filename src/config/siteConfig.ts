...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://hhwzk.cc.cd",
	// 站点描述
	description:
		"本站是一个专注分享优质资源的平台，致力于分享优质源码,副业教程，建站技术，软件工具，自学课程，操作系统，经验教程，实用素材等各个领域的资源型站点，为您提供建站或其他方面的便利。是一个十分值得收藏的网站",
