...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/云朵-城镇-好看.png",
			"assets/images/DesktopWallpaper/云彩-夜晚-夜景.png",			
			
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/小白-木桥-田野.png",
	...
	common: {
		...
		homeText: {
			...
			subtitle: [
				"顺为凡，逆则仙，只在心中一念间。",
				"不惧本心，方为自我，不违本心，是为自在。",
				"雨生于天，死于大地，中间下落的过程，便是人生。",
				"雨落一生，短暂却灿烂，人生亦是如此，哪怕前路荆棘，也要走完全程。",
				"这世上，没有无缘无故的恨，也没有无缘无故的爱。",
				"我花海此生，不拜天地，不敬鬼神，只拜父母。",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
