...
export const site = {
  ...
  avatar: "https://hhwzk.cc.cd/_astro/avatar.DSL-xax2_Z1E5RPs.webp",
  email: "1592757741@qq.com",
};
...
export const notes = [
  ...
  { title: "互换原则", content: "自助审核：提交后会自动检查友链页是否可访问、是否包含本站回链；未通请联系花海" },
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <a href="https://github.com/fqzlr/Firefly/issues/new?template=friend-request.yml"   target="_blank"
                 class="font-semibold text-sm mb-1 inline-block text-(--primary) hover:underline">  自助申请友链 </a>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">点击上方或者页面右上角按钮进入申请表，按提示填写站点信息并提交。</p>
            </div>
          </div>
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <div class="relative rounded-lg bg-black/5 dark:bg-white/5 p-4 pr-10 text-[0.7rem] leading-relaxed overflow-x-auto whitespace-pre">
                ...
                {`站点名称：花海博客\n站点描述：记录生活，分享美好。\n站点链接：https://hhwzk.cc.cd\n头像链接：https://hhwzk.cc.cd/avatar.jpg`}
              </div>
            </div>
          </div>
          ...
          <div class="flex gap-3.5">
            <div class="flex flex-col items-center">
              <div class="w-7 h-7 rounded-full bg-(--primary) text-white text-xs font-bold flex items-center justify-center shrink-0">4</div>
            </div>
            <div>
